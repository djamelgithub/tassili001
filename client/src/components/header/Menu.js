    ...
    return (
        ...
        <div>
            {auth.user && auth.user.role === 'admin' && (
                // Si el usuario está autenticado y es administrador, renderizar contenido para administradores
                <div className="menu">
                    <ul className="navbar-nav flex-row">
                        ...
                        <li className="nav-item dropdown" style={{ opacity: 1 }} >
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <Link className="dropdown-item" to={auth.user && auth.user._id ? `/profile/${auth.user._id}` : "#"}>
                                    Profile
                                </Link>
